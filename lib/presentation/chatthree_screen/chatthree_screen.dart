...
import 'provider/chatthree_provider.dart';

class ChatthreeScreen extends StatefulWidget {
  const ChatthreeScreen({Key? key})
      : super(
          key: key,
        );

  @override
  ChatthreeScreenState createState() => ChatthreeScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ChatthreeProvider(),
      child: ChatthreeScreen(),
    );
  }
}

class ChatthreeScreenState extends State<ChatthreeScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: _buildRowTwentySeven(context),
      ),
    );
  }
  ...
  /// Section Widget
  Widget _buildRowTwentySeven(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(
        left: 61.h,
        right: 53.h,
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child: Selector<ChatthreeProvider, TextEditingController?>(
              selector: (
                context,
                provider,
              ) =>
